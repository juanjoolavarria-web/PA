...
if menu == "Data Room (Subir Cartolas)":
    ...
    if uploaded_file is not None:
        ...
        # Simulación de mapeo para el siguiente paso
        ...
        if st.button("Validar e Inyectar al Portafolio"):
            nueva_fila = {
                ...
                "Moneda": "USD" if "USD" in texto_completo or "$" not in texto_completo else "CLP",
            ...
            st.success("Posición guardada temporalmente en el Overview.")
...
# --- MÓDULO: OVERVIEW ---
    ...
    if df_actual.empty:
        ...
        # Datos visuales de presentación si está vacío
        ...
        # Gráfico dinámico basado en lo que subas
        fig = px.bar(df_actual, x="Activo", y="Monto/NAV", title="Distribución por Activo", color="Moneda")
